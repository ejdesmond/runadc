...
*/
    ...
    UINT32 idcm_read_array32[40000];
    UINT32 idcm_send_array[400000];
    UINT32 idcm_verify_array[400000];
    ...
    int   ij,nsend,iloop,inew,idma_readback,iadd,jevent;
